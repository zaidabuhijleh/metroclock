...
WIFI_SETUP_RETRY_SECONDS = 120
WIFI_MONITOR_INTERVAL_SECONDS = 15
...
# --- CLOUD CONTROL ---
# Optional outbound-only cloud control plane. Disabled by default so local/Pi
# behavior stays exactly the same until pairing is configured.
METROCLOCK_CLOUD_ENABLED = False
METROCLOCK_CLOUD_BASE_URL = ""
METROCLOCK_CLOUD_DEVICE_TOKEN = ""
METROCLOCK_CLOUD_PAIRING_CODE = ""
METROCLOCK_CLOUD_HEARTBEAT_SECONDS = 30
METROCLOCK_CLOUD_COMMAND_POLL_SECONDS = 5
METROCLOCK_CLOUD_PREVIEW_SECONDS = 2
...
RUNTIME_EDITABLE_FIELDS = {
    ...
    "WIFI_SETUP_RETRY_SECONDS",
    "WIFI_MONITOR_INTERVAL_SECONDS",
    "WIFI_SETUP_HOTSPOT_SSID",
    "WIFI_SETUP_HOTSPOT_IP",
    "WIFI_SETUP_HOTSPOT_PASSWORD",
    "WIFI_SETUP_FORCE_HOTSPOT_UNPAIRED",
    "METROCLOCK_CLOUD_ENABLED",
    "METROCLOCK_CLOUD_BASE_URL",
    "METROCLOCK_CLOUD_DEVICE_TOKEN",
    "METROCLOCK_CLOUD_PAIRING_CODE",
    "METROCLOCK_CLOUD_HEARTBEAT_SECONDS",
    "METROCLOCK_CLOUD_COMMAND_POLL_SECONDS",
